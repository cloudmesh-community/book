...
::: {.smalltable}
  ...
  ⭕     09/24           7       Virtualization   Qemu, KVM, Virtual machines
                                II               
  ...
  ⭕     11/19                                    \- [Go for the Cloud](#s-go-cloud)[:cloud](https://github.com/cloudmesh-community/book/blob/master/chapters/prg/go-cloud.md)
