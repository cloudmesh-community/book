...
* Prerequisite(s): Knowledge of a programming language, the ability to
  ...
  using virtual machines and/or containers. Knowledge of material taught by [e516](https://github.com/cloudmesh-community/book/blob/master/chapters/class/e516-engineering-cloud-computing.md) is desirable and will make project execution easier. e516 and this class can be taken in parallel.
...
* Explore state-of-the-art big data and cloud technologies and services while
  providing a write up about it and exploring it practically with a
  tutorial that you develop
...
* Be able to communicate the results through tutorials, manuals, and
  reports.
...
|:------ |:--- |:----------- |:-------------------------
| 08/24  :white_check_mark:   | 1       | Fundamentals      | [Introduction to Big data](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/intro-fall-2018.md) 
| 08/24 :white_check_mark:    | 1       | Introduction      | [Intoduction to Clouds :o:](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/intro-cloud.md) 
| 08/24 :o:    | 1       | Introduction      | outdated - [Definition of Big Data :o:](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/overview.md) 
| 08/31 :o:    |         |                   | (outdated) Definition of Big Data Analysis :o:
| 09/03 :white_check_mark:     |         |                   | [Big Data Use Cases](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/usecases.md) 
| 09/10 :o:    | 2       | Basic Math        | Statistics for Big Data :o: 
| 09/17 :white_check_mark:    |         | Applications      | [Physics and Astronomy](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/physics.md)
| 09/24 :white_check_mark:    | 3       |                   | [Lifestyle and e-Commerce](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/lifestyle.md)
| 10/01 :o:    |         |                   | [kNN and Clustering :o:](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/algorithms/clustering.md), [k-means](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/algorithms/technology.md)
| 10/08 :white_check_mark:     | 3       |                   | [Web Search](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/web.md)
| 10/08 :white_check_mark:     |         |                   | [Sports](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sport.md)
| 10/15 :o:    |         |                   | [Health](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/health.md)
| 10/22 :o:    |         |                   | [Sensor](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sensor.md)
| 10/29 :o:    |         |                   | Radar :o:
| 11/05 :o:    |         | Basic Cloud       | [Cloud Computing for Big Data I :o:](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/cloud.md) (outdated)
| 11/19 :o:    |         |                   | Cloud Computing for Big Data II :o:
| 12/03 :o:    | 4       | Applications    | Edge Computing and the Cloud :o:
...
| 09/03-11/26* | 6       | Project Type A    | Build a Big Data Application Project (maximum grade for class A or A+)
