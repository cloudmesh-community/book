...
| ---- |:------ |:--- |:----------- |:------------------------- |
|  .   | TBD | 1       | Fundamentals      | [Introduction to Big data](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/intro-fall-2018.md) |
|  .   | TBD | 1       | Introduction      | [Intoduction to Clouds](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/intro-cloud.md) |
|  .   | TBD | 1       | Introduction      | [Overview of Big Data](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/overview.md) |
|  .   | TBD |         |                   | [Big Data Use Cases](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/usecases.md) |
|  .   | TBD | 2       | Basic Math        | [Minimal Statistics](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/statistics.md) |
|  .   | TBD |         | Applications      | [Physics and Astronomy](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/physics.md) |
|  .   | TBD | 3       |                   | [Lifestyle and e-Commerce](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/lifestyle.md) |
|  .   | TBD |         |                   | [kNN and Clustering](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/lifestyle.md) |
|  .   | TBD |         |                   | [k-means](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/kmeans.md) |
|  .   | TBD |         |                   | [Web Search](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/web.md) |
|  .   | TBD |         |                   | [Sports](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sport.md) |
|  .   | TBD |         |                   | [Health](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/health.md) |
|  .   | TBD |         |                   | [Sensor](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sensor.md) |
|  .   | TBD |         |                   | [Radar](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/radar.md) |
|  .   | TBD | 4       | Basic Cloud       | Cloud Computing for Big Data I  |
|  .   | TBD |         |                   | Cloud Computing for Big Data II |
|  .   | TBD | 5       | Applications      | Edge Computing and the Cloud  |
|  .   | TBD* | 5       | Technology Summaries          | Contribute your assigned technology summaries while not plagiarizing. |
|  .   | TBD* | 5       | Example          | Contribute a significant technical example related to Big Data technologies. Do not develop redundant or duplicated content. |
|  .   | TBD* | 5       | Chapter          | Contribute a significant chapter while not plagiarizsing that may use your example to the class documentation. Do not develop redundant or duplicated content. |
|  .   | TBD* | 6       | Project Type A    | Build a Big Data Application Project (maximum grade for class A or A+) |
|  .   | TBD* |         | Project Type B    | Write a comprehensive Report without programming (maximum grade for entire class A-) |
...
:o2: Note that the calendar will be updated in the second week of the
semester.
