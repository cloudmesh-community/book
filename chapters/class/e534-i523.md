# e534-i523: Big Data Applications and Big Data Applications Analytics
...
* Prerequisite(s): Knowledge of a programming language, the ability to
  ...
  using virtual machines and/or containers. Knowledge of material taught by [e516](https://github.com/cloudmesh-community/book/blob/master/chapters/class/e516-engineering-cloud-computing.md) is desirable and will make project execution easier. e516 and this calss can be taken in parallel.
...
| 08/24     | 1       | Introduction      | [Definition of Clouds (old)](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/intro-cloud.md) 
| 08/24     | 1       | Introduction      | outdated - [Definition of Big Data](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/overview.md) 
| 08/31     |         |                   | (outdated) Definition of Big Data Analysis
| 09/03     |         |                   | [Big Data Use Cases](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/usecases.md)
| 09/10     | 2       | Basic Math        | (New) Statistics for Big Data 
| 09/17     |         | Applications      | [Pyhsics and Astronomy](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/physics.md)
| 09/24     | 3       |                   | [Lifestyle and e-Commerce](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/lifestyle.md)
| 10/01     |         |                   | [kNN and Clustering](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/algorithms/clustering.md), [k-means](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/algorithms/technology.md)
| 10/08     | 3       |                   | [Web Search](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/web.md)
| 10/08     |         |                   | [Sports](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sport.md)
| 10/15     |         |                   | [Health](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/health.md)
| 10/22     |         |                   | [Sensor](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/sensor.md)
| 10/29     |         |                   | Radar (needs to be updated)
| 11/05     |         | Basic Cloud       | [Cloud Computing for Big Data I](https://github.com/cloudmesh-community/book/blob/master/chapters/bigdata/applications/cloud.md) (outdated)
| 11/19     |         |                   | Cloud Computing for Big Data II (outdated)
| 12/03     | 4       | Applications    | Edge Computing and the Cloud
