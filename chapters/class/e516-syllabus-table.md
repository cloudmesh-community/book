...
| + | :o:  | A1 | Sections           | Contribute significant sections. Do not  develop redundant or duplicated content. |
| + | :o:  | A2 | Chapter            | Contribute a significant chapter that may use your section to the class documentation. Do not develop redundant or duplicated content. |
| + | :o:  | A3 | Project Report draft due | Develop a draft for the project. This is a hard deadline as we integrate your draft into a proceedings over the berak.  |
| + | :o:  | A3 | Project Type A     | Build a cloud clustert out of Raspberry PIs |
