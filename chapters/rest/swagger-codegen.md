...
termOfService attribute is and suggest a better value. Discuss on piazza.
...
prepare a larger assignment. Think about this first before you implement.
...
real implementation of the business logic. Try with complex
