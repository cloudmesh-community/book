...
will start a node.js container, inject our previously-mentioned code to it,
...
In case you have services running on any of the ports, you can
...
quick-start` command that we used previously for starting the platform, the
