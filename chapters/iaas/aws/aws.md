...
in Figure next: @fig:aws-products-1, @fig:aws-products-2.
...
including your email address as shown in the image next: @fig:aws-signup.
...
tier agreement and you will be charged for them, see picture next: @fig:free-tier. To view all the AWS
...
eligible as shown in the image next: @fig:instance-type. Now that you have selected all
...
shown in the image next: @fig:running-instance1. If you do not see is initially, refresh the
