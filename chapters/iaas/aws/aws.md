...
in next Figure: @fig:aws-products-1, @fig:aws-products-2.
...
that are available In Sep. 2018 below.
...
including your email address as shown in the next image: @fig:aws-signup.
...
provided. AWS will ask for credit/debit card details as shown next: @fig:payment-information.
...
services that are available to you through AWS as shown in the next image
: @fig:aws-console.
...
tier agreement and you will be charged for them, see  next picture: @fig:free-tier. To view all the AWS
...
eligible as shown in the next image: @fig:instance-type. Now that you have selected all
...
shown in the next image: @fig:running-instance1. If you do not see is initially, refresh the
