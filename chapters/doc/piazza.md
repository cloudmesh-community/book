...
1.  Click the Piazza link on the left navigation of your Canvas course.
2.  Proceed as in previous \#1. This will create your new Piazza account
...
2.  If none of your accounts corresponds to your default IU email
    address, follow the previous instructions in \#3.
3.  If you wish to merge other accounts that you own, please see [Add an
    email address or merge two
...
The previous question will simply be commented on (if at all):
...
form your class.
  ...
  discussion   Any content that deserves its separate discussion and is not covered in the previous folder.
